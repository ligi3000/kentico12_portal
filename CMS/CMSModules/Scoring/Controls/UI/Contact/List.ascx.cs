    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        switch (what)
        {
            ...
            case What.All:
                ...
                contactsQuery = ContactInfoProvider.GetContacts().WhereIn("ContactID", contactsIds);
                break;

            // Selected items
            case What.Selected:
                // Get selected IDs from unigrid
                contactsQuery = ContactInfoProvider.GetContacts().WhereIn("ContactID", gridElem.SelectedItems);
                break;
        }
