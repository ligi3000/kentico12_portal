...
public partial class CMSModules_Membership_Pages_Users_User_Edit_Membership : CMSUsersPage
{
    ...
    private void SaveData()
    {
        ...
        if (!String.IsNullOrEmpty(items))
        {
            ...
            foreach (string item in newItems)
            {
                ...
                var membership = MembershipInfoProvider.GetMembershipInfo(membershipID);
    ...
    {
        var data = MembershipUserInfoProvider.GetMembershipUsers().Where("UserID = " + UserID).Column("MembershipID").GetListResult<int>();
