...
(function($) {
    var NivoSlider = function(element, options){
        ...
        slider.append($('<div class="nivo-caption nivo-caption-3"></div>'));
        slider.append($('<div class="nivo-caption nivo-caption-4"></div>'));
        slider.append($('<div class="nivo-caption nivo-caption-5"></div>'));
        ...
        if(settings.controlNav){
            ...
            for(var i = 0; i < kids.length; i++){
                if(settings.controlNavThumbs){
                    ...
                    if(child.attr('data-thumb')) vars.controlNavEl.append('<a class="nivo-control" ><img src="'+ child.attr('data-thumb') +'" alt="" /></a>');
                } else {
    ...
    $.fn.nivoSlider.defaults = {
        ...
        slideshowEnd: function(){effect:'fade'},
        lastSlide: function(){},
        afterLoad: function(){}
    };
